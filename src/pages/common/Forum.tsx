...
// ✅ XÓA 3 DÒNG CODE NÀY (đang ở ngoài component)
...
export default function Forum(): React.ReactElement {
  ...
  // ✅ ĐÚNG - Hooks phải ở bên trong component
  const theme = useTheme();
  const isMobile = useMediaQuery(theme.breakpoints.down("sm"), {
    noSsr: true,
  });
        ...
        <Container maxWidth="lg">
          ...
          >
            ...
            >
              ...
              {/* Chỉ hiển thị Button trên desktop , nút fab hiện thị trên  */}
              {!isMobile && (
                <Button
                  variant="outlined"
                  startIcon={<Add />}
          ...
          {/* danh mục sửa phần danh mục khi xem trên điện thoại ra giữa, còn máy tính giữ nguyên  */}
          <MotionBox
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
